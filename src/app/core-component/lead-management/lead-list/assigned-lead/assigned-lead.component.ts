...
import { AssignedLeadService } from './assigned-lead.service';
...
export class AssignedLeadComponent {
  ...
  public tooltipMessage: string = 'Copy';
      ...
      constructor(
        ...
        private assignedLeadService: AssignedLeadService,
      ...
      geAssignedList(requestFor: any) {
        this.assignedLeadService.geAssignedList(requestFor,'ASSIGNED')
          .subscribe((apiRes: any) => {
            this.setTableData(apiRes);
          });
      }
      ...
      filterByDate() {
        this.assignedLeadService
          .geAssignedList('TODAY','ASSIGNED')
          .subscribe((apiRes: any) => {
            this.setTableData(apiRes);
          });
      }
