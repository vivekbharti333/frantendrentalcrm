...
export class EnquiryComponent {
  public tooltipMessage: string = 'Copy';
      ...
      submitSeachByDateForm() {
        this.enquiryService.getEnquaryListByDateSearch(this.searchByDateForm.value)
          .subscribe((apiRes: any) => {
            this.setTableData(apiRes);
          });
      }
    
      getEnquiryList(requestFor: any) {
        this.enquiryService.getEnquiryList(requestFor,'ENQUIRY')
          .subscribe((apiRes: any) => {
            this.setTableData(apiRes);
          });
      }
