  ...
  addCategoryDetails(addCategory: any): Observable<any> {
    let request: any = {
      payload: {
        ...
        pickupLocation: addCategory.pickupLocation,
        dropLocation: addCategory.dropLocation,
    ...
    let request: any = {
      payload: {
       categoryImage: editCategory.categoryImage,
        ...
        pickupLocation: editCategory.pickupLocation,
        dropLocation: editCategory.dropLocation,
